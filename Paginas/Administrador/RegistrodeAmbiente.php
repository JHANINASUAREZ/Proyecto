    ...
    <header class="headerHU">
        <div class="header-content">
            ...
            <span class="header-title"
                ...
                DE RESERVA DE AULAS DE FCyT-Prueba</span>
        ...
        <ul class="ul sidebar-nav">
            ...
            <li class="sidebar-item">
                <a href="#" class="sidebar-link" style="text-decoration: none;">
                    <img width="25" height="25" src="https://img.icons8.com/ios-filled/50/classroom.png" alt="classroom"
                ...
                <div class="modal-content" style="background-color:#5542fa; padding: 20px; border-radius: 10px;">
                    <div class="modal-header d-flex justify-content-center">
                        <h5 class="modal-title text-center" id="exampleModalLabel2"
                            style="font-size: 24px; color: white;">Registrar Ambiente</h5>
                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="form-group" style="text-align: center;">
                                        ...
                                        <button type="reset" class="btn btn-danger" style="margin-left: 10px;"
                                            onclick="window.location.href='RegistrodeAmbiente.php'">Cancelar</button>
                                    </div>
